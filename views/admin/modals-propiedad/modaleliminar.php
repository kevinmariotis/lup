...
<div class="modal fade" id="eliminar<?php echo $resultado['codigo']; ?>" tabindex="-1" aria-labelledby="registroLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../admin/admin-propiedades.php" method="post">
                    <ol class="list-group my-2">
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Codigo</div>
                                <input class="border-0" name="codigo_eliminar" value="<?php echo $resultado['codigo']; ?>">
                            </div>
                        </li>
                    </ol>
                    <ol class="list-group my-2">
